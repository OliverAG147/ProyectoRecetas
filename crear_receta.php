...
<?php 
    ...
    if(isset($_POST['btncrear'])){
        ...
        $image = $_FILES['img_receta']['tmp_name'];
        $imgContenido = addslashes(file_get_contents($image));

        $consulta="INSERT INTO receta (name_receta,ingrediente_receta,procedimiento_receta,img_receta,categoria,pais) 
        VALUE ('$name_receta', '$ingrediente_receta', '$procedimiento_receta','$imgContenido', '$categoria', '$pais')";
...
<html lang="es">
    ...
    <body>
        <header id="header">
            <div id="wrap"> <!--Margen de la barra de navegación-->
                <div id="logo">
                    <a href="home.php"></a>
                </div>
        ...
        <div class="page-content"> <!-- Contenido -->
            <div class="container-fluid">
                <div class="box-typical box-typical-padding">
                    <p>Desde esta ventana podrás generar nuevas recetas:</p>
                    <h5 class="m-t-lg with-border">Ingresar Información</h5>   
                    <form method="POST" action="" enctype="multipart/form-data"> <!-- Formulario -->
                        <div class="row">                                       
                            <div class="col-lg-2">
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="file" name="img_receta" id="img_receta" multiple>
                            </div>
                            <div class="col-lg-4">
